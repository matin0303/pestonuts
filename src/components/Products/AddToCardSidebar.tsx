...
import { addToCart, loadCart } from '@/lib/redux/slices/shoppingCardSlice'
...
export default function AddToCardSidebar({ data }: AddToCardSidebarProps) {
	...
	return (
		<div className='sticky top-0 left-0 max-lg:hidden w-200 min-h-140 rounded-sm shadow-md py-10 px-5 text-gray-700'>
